...
import (
	...
	"stockwise/internal/naren/analysis/alpha"
...
func NewHandler(repo *storage.Repository, engine *strategy.Engine, cfg *config.Config, newsMonitor *news.Monitor) *Handler {
	return &Handler{repo: repo, strategyEngine: engine, cfg: cfg, newsMonitor: newsMonitor}
}
